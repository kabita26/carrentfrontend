      ...
      <div className="bg-white shadow-lg rounded-lg p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg text-gray-600"><span className="font-semibold">Brand Name:</span> {car.brand}</p>
            <p className="text-lg text-gray-600"><span className="font-semibold">Model Name:</span> {car.model}</p>
            <p className="text-lg text-gray-600"><span className="font-semibold">Manufacturing Year:</span> {car.year}</p>
